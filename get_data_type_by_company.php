...
while($row = $result->fetch_assoc()){
    ...
    $bullshit[$i] = $row["company_income"];
    $i++;


    $bullshit[$i] = $row["company_balance"];
    $i++;


    $bullshit[$i] = $row["company_cash"];
    $i++;


    $bullshit[$i] = $row["company_equity"];
    $i++;


    $bullshit[$i] = $row["company_liquidity"];
    $i++;


    $bullshit[$i] = $row["company_income_banks"];
    $i++;
